...
| 페이지 | 타입 | 한 줄 설명 |
|--------|------|------------|
| [[쓰가루_다메노부]] | entity | 번조(藩祖). 오우라 → 쓰가루 개성. 전국시대 후반 쓰가루 통일·후지와라 자칭의 정치학 |
| [[히로사키번]] | entity | 히로사키번 에도시대 전체사. 12대 번주·석고 4만 7천→10만 석·샤크샤인 토벌·기근·소마 대작 사건 |
| [[보신전쟁_히로사키번]] | concept | 1868년 동맹 가맹→이탈→노헤지 야습. 관군 실적 쌓기 방화와 賞典禄 1만 석 결과 |
| [[쓰가루씨_화족]] | entity | 메이지 화족 백작·자작·남작 3가. 14대 요시타카·히타치노미야비 하나코·15대 당주 쓰스무 |
...
| [[LAKA_조직도_2026-05]] | summary | 라카 사내 조직도 스냅샷 (2026-05-18, 8부문 약 93명) |
| [[src_매직립픽서_2차CT_260520]] | summary | 차승호 매니저 매직립픽서 2차 CT 일정·사양변경(SUS316/표면처리업체/박킹십자절개) + 신제품 CT 진행 문의 (5/20) |
...
> `wiki/industry/LAKA/QA팀/` — 차승호 품질팀장 부임 이후 QA팀 셋업·운영 기록 모음
...
| [[Slack_품질팀_시작_가이드]] | concept | 처음 쓰는 분들 위한 1페이지 가이드 (메시지·스레드·멘션·검색·핀고정·비밀채널) + 5채널 안내 + FAQ |
| [[차승호_1차미팅_아젠다]] | log | 본부장→차승호 팀장 1차 미팅 아젠다 누적 — #1 R&R 매핑 갭(4Q) + #2 Slack 5채널(6Q, 🚨5/22 마감) + #4 향료 25종(5Q). #3 예약 |
| [[차승호_1차미팅_송부메시지]] | log | 1차 미팅 송부 메시지 초안 — A(짧은 미팅 제안, 추천) + B(긴 이메일) 두 버전, 첨부·채널·후속 운영 |
| [[차승호_2차미팅_아젠다]] | log | 2차 미팅 아젠다(com-43, **#5~#10 21Q**) — #5 외부담당자(4Q, Q3 ✅) + #6 외부팀 커뮤니케이션(3Q, ✅처리) + #7 법령 자동 봇(본부장 직접) + #8 #4 일반화(4Q) + **🚨#9 QC 운영 거버넌스 4갭(4Q, 대표 보고 정합)** + #10 트윈립·화성 ABS·본딩글로우 전환(3Q) |
| [[차승호_1차미팅_후속메일_2026-05-19]] | log | 5/19 미팅 직후 후속 메일 초안 — 액션 4건(정/부 5건 회신·Slack 의견+이메일 포워딩·법령봇 본부장 직접·트윈립 금형) + 별송 ①·②·③ |
| [[QA팀_이관업무_2026]] | summary | 차승호 부임 시점 이관업무 엑셀 분석 — 15건 이관(BM6·구매3·디자인2·영업1·해외영업1·본부장1)+신설2+유지1 · 🚨생산실적 R&R 누락 · SharePoint 8폴더 · 매뉴얼 ToDo 미확인 |
| [[CT결과서_폴더_2026]] | summary | CT결과서 SharePoint 미러 폴더 분석 — 191파일·5 ODM·45 SKU · ✅트윈립=퍼펙트트윈립 캡 금형 마모(유림테크) 확정 · 화성 스테인립라이너 조건부적합·ABS 가이드라인 위반 · 월 평균 10건 CT 검수 부담 |
| [[퍼펙트트윈립_캡금형마모_2026Q2]] | summary | 트윈립 금형 이슈 = 유림테크 캡 사출 금형 4만타 초과 마모 · v4 언더컷 5/말 t-0·6월 둘째주 전체 적용 · 수리 1.5-2일/40k EA 감소 · 차승호 판단 수리 후 납기 · 대표 보고 3줄 요약 포함 |
| [[QC업무_폴더_2026]] | summary | QC업무 9개 하위폴더 + 마스터 엑셀 분석 — 1월 PPT 두 제품(본품·미니 #181-200 EL001 40COA / 미니듀오 5SKU) 적합 근거 확정 + 🚨마스터리스트 2025-08-29 이후 8.5개월 정체 + 프루티글램 표준서 부재 |
| [[안전관리정보_자동수집_제안]] | summary | 안전관리 정보 수집(R&R 15번) 자동화 — 3계층 아키텍처, 4주 실행 일정, Slack `#qa-시그널-피드` 신설 |
| [[안전관리정보_자동수집_1단계_스펙]] | summary | 1단계 운영 스펙 (Slack·인력) — **보류** (기술 검증 우선) |
| [[안전관리정보_자동수집_기술검증]] | summary | 1단계 기술 PoC 완료 — 9개 RSS·API 출처에서 503건 자동 수집 성공 (PowerShell, 비용 0원) |
...
| [[스테인리스_등급_SUS304_SUS316]] | concept | 화장품 팁·솔대·스프링용 SUS 등급 비교 — Mo 2% 추가가 염소·약산 내식 1단계 업그레이드, 매직립픽서 2차 CT 트리거 |
...
| [[src_식약처_착향제_알레르기_2020]] | summary | 식약처 「화장품 향료 중 알레르기 유발물질 표시 지침」 (2020.1.1) — 25종 임계치·세부 13항·증빙자료 4종 |
...
| [[EU_향료_알레르겐_80종_SOP]] | concept | 🚨 Reg. EU 2023/1545 2026.7.31 발효 (D-74일) — LAKA 4-Phase 행동 계획 (인벤토리·라벨 재설계·온라인 동기화·D-Day 점검) + 한국 25종 선례 활용 |
...
| 페이지 | 타입 | 한 줄 설명 |
|--------|------|------------|
| [[sop_overview]] | concept | 개요. LAKA Designer/Distributor 매핑, Volume/Mix, 4-tier 호라이즌, 5-step, 4 인풋, Maturity 진단, 로드맵 |
